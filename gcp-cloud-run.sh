...
show_404_banner() {
  ...
  printf "║         ${C_404_GREEN}⚡ Powered by Khaled_Deragha                                                ${C_404_RED}\n"
  printf "║                                                                                               ${C_404_RED}\n"
  printf "╚══════════════════════════════════════════════════════════════════╝${RESET}\n"
  printf "\n\n"
}
...
DEFAULT_LABEL="Join Khaled_Deragha "
...
URI="vless://${VLESS_UUID}@vpn.googleapis.com:443?path=%2F%40nkka404&security=tls&encryption=none&host=$(basename ${SERVICE_URL#https://})&type=ws&sni=vpn.googleapis.com#Khaled_Deragha -VLESS-WS"
...
show_divider
printf "\n${C_404_RED}${BOLD}4 0 4${RESET} ${C_404_GRAY}|${RESET} ${C_404_CYAN}VLESS WebSocket Deployment System${RESET} ${C_404_GRAY}|${RESET} ${C_404_GREEN}v2.1${RESET}\n"
