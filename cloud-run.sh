...
show_404_banner() {
  ...
  printf "║         ${C_404_GREEN}⚡ Powered by Khaled_Deragha_                                               ${C_404_RED}\n"
  printf "║                                                                                               ${C_404_RED}\n"
  printf "╚══════════════════════════════════════════════════════════════════╝${RESET}\n"
  printf "\n\n"
}
...
DEFAULT_LABEL="Join Khaled_Deragha_"
...
URI="vless://${VLESS_UUID}@vpn.googleapis.com:443?path=%2F%40nkka404&security=tls&encryption=none&host=${CANONICAL_HOST}&type=ws&sni=${CANONICAL_HOST}#Khaled_Deragha -VLESS-WS"
...
━━━━━━━━━━━━━━━━━━━━━━━━━━
<b>Powered by Khaled_Deragha_</b>
EOF
)
